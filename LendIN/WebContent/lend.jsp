...
.navbar-brand>img {
  ...
  width: auto;
    	...
    	<ul class="nav navbar-nav">
      		...
      		<li class="active"><a href="lend.jsp">Want to Lend?</a></li>
  ...
  <br><br>
	...
	<div class="row">
		<div class="col-lg-6">
		<div class="jumbotron">
		<h2>Why invest on LendIn?</h2>	
	<ul>
	<li>View latest transactions as they are conducted.</li>
	<li>Total transparency.</li>
	<li>Freedom to choose who you invest your money in.</li>
	<li>Opportunity to negotiate with the borrower before closing a deal.</li>
	</ul>
		</div>
		</div>
		<div class="col-lg-6">
		<img src="img/investor.png" width="70%">
		</div>
