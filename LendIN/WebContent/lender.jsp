...
.navbar-brand>img {
  ...
  <br><br>
	...
	%>
  	...
  	<h2>Lender</h2>
  	<h5>In order to lend money please provide us with a few necessary details: </h5>
  	<br>
  	
  	<form action="Lender">
  	
  	<div class="form-group">
    <label for="amount">Amount of Fund You want to invest:</label>
    ...
    <input type="number" class="form-control" id="tenure" name="tenure" placeholder="(In months) for which fund is to be invested">
  	</div>
  	  	<div class="form-group">
